\begin{tikzpicture}[scale=1.5]
	...
	\node at (7.4,0){$\shortstack{F(\text{WHILE}) = F(\text{RAM}) \\ (Funzioni Parziali)}$};
	...
	\node at (6.72,-1.3){$\overset{\text{\textbullet}}{ \shortstack{$\mathcal{A}(m,n)=\text{Ackermann}$ \\ (Funzione Totale)}}$};
\end{tikzpicture}
