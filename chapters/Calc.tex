...
\begin{proof}
	...
	$$ P \in \prog \bbar \varphi_P (\langle x,y \rangle) = x + y $$
...
\begin{proof}
	...
	$$ \exists m \in \N \bbar \varphi_m (i) = t\left(S_1^1 (e,i)\right) $$
...
a='a=%r;print(a%%a)';print(a%a)
	...
	$$ \exists j \in \N \bbar \varphi_j (x) = j \text{ per ogni input } x \in \N \text{?}$$
...
$$ \exists j \in \N \bbar \varphi_j (x) = \varphi_{Z (j)} (x) = j $$
...
Per il teorema di ricorsione
$$ (\ast \ast) \quad \quad \exists i \in \N \bbar \varphi_i = \varphi_{g(i)} $$

Unendo $(\ast)$ e $(\ast \ast)$ otteniamo 
$$ \exists i \in \N \bbar \Psi_{t(i)} \stackrel{(\ast)}{=} \varphi_{g(i)} \stackrel{(\ast \ast)}{=} \varphi_i \quad \forall t \in \T $$
...
$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_x \left(n + \varphi_{\varphi_n (0)} (x) \right) $$
...
$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_{S^1_1 (e,n)} (x) = \varphi_x \left(n + \varphi_{\varphi_u (0,n)} (x)\right) $$

\subsubsection{Esercizi}

In tutti gli esercizi viene dato un SPA $\{\varphi_i\}$

$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_x (n) + \varphi_{\varphi_x (n)} (n)? $$
\begin{align*}
...
$$ \exists n \in \N \bbar \varphi_n (x) = n^x + \left(\varphi_x (x)\right)^2 ? $$
\begin{align*}
...
$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_x \left(\langle n, \varphi_x (1) \rangle \right) ?$$
\begin{align*}
	...
	& \fin 
\end{align*}
$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_{\varphi_x (\sin (n))} (\des (n)) ? $$
\begin{align*}
...
\begin{align*}
	...
	& \fin \\
\end{align*}
$$ \exists n \in \N \bbar \varphi_n (x) = \varphi_x (n + 2) + \left(\varphi_{\varphi_x (n)} (n+3)\right)^2 ? $$
\begin{align*}
