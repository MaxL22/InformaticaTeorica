...
\begin{theor}
	...
	$$ \exists n \in \N | \varphi_n = \varphi_{t(n)} $$
\end{theor}
...
\begin{enumerate}
	...
	\item La domanda iniziale è diventata $\exists n \in \N$ $|$ $\varphi_n (x) = \varphi_{S_1^1 (e,n)} (x)$? 
...
% TODO: - nella definizione delle funzioni, cambiare tutti i | con \mid
